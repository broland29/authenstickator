...
class LoggerManager:
    ...
    def __new__(cls):
        ...
        # against "UnicodeEncodeError: 'charmap' codec can't encode characters" error
        ...
        file_handler = RotatingFileHandler(log_file_path, maxBytes=1044 * 1024, encoding="utf-8")
